...
with tabs[6]:
    ...
    st.markdown("### 🟢 Verified Safe (Competitive Advantages)")
...
with tabs[7]:
    ...
    st.markdown("### 🏆 When to Choose Vonoprazan")
...
with tabs[9]:
    ...
    st.markdown("### ❤️ Leadership in Gastrointestinal Health")
